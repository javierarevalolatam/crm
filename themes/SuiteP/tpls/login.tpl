...
<div class="p_login">
    ...
    <div class="p_login_bottom">
    		<div>Versión de <strong>SuiteCRM</strong> desarrollada por<a href="http://tstalent.net" target="_blank" style="color:#E05A00;"><strong>TS Talent Soluciones, C.A.</strong></a> bajo el Framework TS Expressions. Powered By <strong>SugarCRM</strong>.</div>
    </div>
