<?php /* Smarty version 2.6.29, created on 2017-09-20 11:11:23
         compiled from cache/include/InlineEditing/UsersEditViewUserType.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/include/InlineEditing/UsersEditViewUserType.tpl', 10, false),array('function', 'sugar_getimagepath', 'cache/include/InlineEditing/UsersEditViewUserType.tpl', 43, false),array('modifier', 'lookup', 'cache/include/InlineEditing/UsersEditViewUserType.tpl', 38, false),array('modifier', 'count', 'cache/include/InlineEditing/UsersEditViewUserType.tpl', 143, false),)), $this); ?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
	<select name="<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
" 
	id="<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
" 
	title=''  tabindex="1"       
	>

	<?php if (isset ( $this->_tpl_vars['fields']['UserType']['value'] ) && $this->_tpl_vars['fields']['UserType']['value'] != ''): ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['UserType']['options'],'selected' => $this->_tpl_vars['fields']['UserType']['value']), $this);?>

	<?php else: ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['UserType']['options'],'selected' => $this->_tpl_vars['fields']['UserType']['default']), $this);?>

	<?php endif; ?>
	</select>
<?php else: ?>
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['UserType']['options']); ?>
	<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['UserType']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	...
	<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>

			<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
" 
		id="<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
" 
		title=''  tabindex="1"          
	...
	<input
		id="<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
-input"
		name="<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
-input"
		size="30"
...
-image"></button><button type="button"
	        id="btn-clear-<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
-input"
	        title="Clear"
	        onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
...
<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['UserType']['name']; ?>
');
