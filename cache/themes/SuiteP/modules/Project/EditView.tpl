...
<input type="text" name="{$fields.am_projecttemplates_project_1_name.name}" class="sqsEnabled" tabindex="" id="{$fields.am_projecttemplates_project_1_name.name}" size="" value="{$fields.am_projecttemplates_project_1_name.value}" title='' autocomplete="off"  	 >
...
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.am_projecttemplates_project_1_name.name}" id="btn_{$fields.am_projecttemplates_project_1_name.name}" tabindex="" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
...
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.am_projecttemplates_project_1_name.name}" id="btn_clr_{$fields.am_projecttemplates_project_1_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
