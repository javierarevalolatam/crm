...
{html_options id='product_category_advanced' name='product_category_advanced[]' options=$fields.product_category_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.product_category_advanced.value}
   	   	</div>
</div>
</div>
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
