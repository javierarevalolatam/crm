...
<tr valign="middle">
<td nowrap>
<input autocomplete="off" type="text" id="{$fields.date_end.name}_date" class="datetimecombo_date" value="{$fields[$fields.date_end.name].value}" size="11" maxlength="10" title='' tabindex="" onblur="combo_{$fields.date_end.name}.update();" onchange="combo_{$fields.date_end.name}.update(); SugarWidgetScheduler.update_time();"    >
...
<script type="text/javascript" src="{sugar_getjspath file="include/SugarFields/Fields/Datetimecombo/Datetimecombo.js"}"></script>
<script type="text/javascript">
var combo_{$fields.date_end.name} = new Datetimecombo("{$fields[$fields.date_end.name].value}", "{$fields.date_end.name}", "{$TIME_FORMAT}", "", '', false, true);
//Render the remaining widget fields
