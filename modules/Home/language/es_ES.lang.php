...
//ABOUT page
    ...
    'LBL_VIEWLICENSE_COM' => '<P>Este programa es software libre, puede redistribuirlo y/o modificarlo bajo los términos de la <a href="LICENSE.txt" target="_blank" class="body"> GNU Affero General Public License versión 3</a> publicada por la Free Software Foundation, incluyendo el permiso adicional en la cabecera del código fuente.</P>',
    'LBL_ADD_TERM_COM' => '<P>Las interfaces de usuario interactivas modificadas en versiones de código fuente y de objeto de este programa deben mostrar los Avisos Legales Apropiados, según lo dispuesto en el artículo 5 de la GNU Affero General Public License versión 3. De acuerdo con la sección 7 (b) de la GNU General Public License versión 3, estos Avisos Legales Apropiados deben mantener la imagen del logo "Powered por SugarCRM". Si la imagen del logotipo no es razonablemente factible por razones técnicas, los Avisos Legales Apropiados debe mostrar las palabras "Impulsado por SugarCRM".</P>',


  'LBL_SUGAR_COMMUNITY_EDITION' => 'Sugar Edición Community',
  'LBL_AND' => "y",
  'LBL_ARE' => "son",
  ...
  'LBL_DETAILS_SUGARFORGE' => 'Colabore y desarolle extensiones de SuiteCRM',
  'LBL_DETAILS_SUGAREXCHANGE' => 'Compre y venda extensiones certificadas de SuiteCRM',
 ...
 'LBL_GET_SUGARCRM_RSS' => 'Suscríbase a Canales sobre SuiteCRM',
  ...
  'LBL_SUGARFORGE_NEWS' => 'Noticias sobre SuiteCRM',
